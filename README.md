# TelesPiano - Interactive Web Piano

An interactive virtual piano application that translates user click interactions into direct real-time audio playback handlers. The project explores advanced native layouts, showcasing explicit absolute overlay position parameters alongside multi-track DOM audio node manipulation workflows.
...
```text
├── index.html       # DOM matrix layout and integrated audio elements
├── index.css        # Multi-layer layout grids and positioning styles
├── script.js        # Playback controllers and isolation algorithms
└── musics/          # Localized sound asset directories
    ├── light-notes/ # White key audio stems (classical tracks)
    └── dark-notes/  # Black key sharp note audio files 
```  
## 🔧 Getting Started  

To test and play the instrument locally:  
